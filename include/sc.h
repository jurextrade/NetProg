...
extern "C" {
    ...
    extern SCPROCRESULT  SCDialProc         (SC* psc,  SCAction* thisaction);
    extern SCPROCRESULT  SCHangUpProc       (SC* psc,  SCAction* thisaction);
    extern SCPROCRESULT  SCDialStatusProc   (SC* psc,  SCAction* thisaction);
    extern SCPROCRESULT  SCSetDialEntryProc (SC* psc,  SCAction* thisaction);
