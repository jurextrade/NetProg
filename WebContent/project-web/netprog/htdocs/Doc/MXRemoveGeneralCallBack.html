...
<title>C NetProg Library : MXRemoveGeneralCallBack</title>
</head>
...
<table border="0" width="100%">
  <tr>
    <td valign="top" width="100%"><b><font face="Verdana" size="4" color="#000080">MXRemoveGeneralCallBack</font></b></td>
  ...
  <tr>
    <td align="left" valign="top"><font face="Verdana" size="2" color="#000080">#include
      ...
      <table border="0" cellpadding="0" cellspacing="0" width="100%">
        ...
        <tr>
          <td width="0%"></td>
          <td width="50%"><b><font face="Verdana" color="#000080" size="2">int        MXRemoveGeneralCallBack (MX* pmx, char* classname, char* messname, BYTE mode, int (*funct)(MXMessage* pmessage, MXCom* pcom, void* applicationfield), void* applicationfield)</font></b></td>
        </tr>
      </table>
