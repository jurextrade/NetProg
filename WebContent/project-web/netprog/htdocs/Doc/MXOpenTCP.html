...
<title>C NetProg Library : MXOpenTCP</title>
</head>
...
<table border="0" width="100%">
  <tr>
    <td valign="top" width="100%"><b><font face="Verdana" size="4" color="#000080">MXOpenTCP</font></b></td>
  ...
  <tr>
    <td align="left" valign="top"><font face="Verdana" size="2" color="#000080">#include
      ...
      <table border="0" cellpadding="0" cellspacing="0" width="100%">
        ...
        <tr>
          <td width="0%"></td>
          <td width="50%"><b><font face="Verdana" color="#000080" size="2">MXCom*     MXOpenTCP  (MX* pmx, char*
            machinename, int port, int protocol, char* user, char* appliname, BOOL block)</font></b></td>
        </tr>
      </table>
    </td>
  </tr>
...
<table border="0" width="100%" bordercolor="#000000" bordercolordark="#000080" bordercolorlight="#000080">
  ...
  <tr>
          <td width="10%" align="left"><font face="Verdana" color="#000080" size="2"><i>machinename</i></font>&nbsp;</td>
          <td width="20%" align="left"><font face="Verdana" size="2" color="#000080">the
            machine name or machine IP address</font></td>
  </tr>
  
  <tr>
          <td width="10%" align="left"><font face="Verdana" color="#000080" size="2"><i>port</i></font>&nbsp;</td>
          <td width="20%" align="left"><font face="Verdana" size="2" color="#000080">the
            port on which to connect&nbsp;</font></td>
  </tr>
  
  <tr>
          <td width="10%" align="left"><font face="Verdana" color="#000080" size="2"><i>protocol</i></font>&nbsp;</td>
          <td width="20%" align="left"><font face="Verdana" size="2" color="#000080">the
            protocol used for this connection</font></td>
  </tr>
  
  <tr>
          <td width="10%" align="left"><font face="Verdana" color="#000080" size="2"><i>user</i></font>&nbsp;</td>
          <td width="20%" align="left"><font face="Verdana" size="2" color="#000080"></font></td>
  </tr>
  
  <tr>
          <td width="10%" align="left"><font face="Verdana" color="#000080" size="2"><i>appliname</i></font>&nbsp;</td>
          <td width="20%" align="left"><font face="Verdana" size="2" color="#000080">the
            application name for local connections (not used)</font></td>
  </tr>
  
  <tr>
          <td width="10%" align="left"><font face="Verdana" color="#000080" size="2"><i>block</i></font>&nbsp;</td>
          <td width="20%" align="left"><font face="Verdana" size="2" color="#000080">whether
            to block until function returns</font></td>
  </tr>
...
<p><font face="Verdana" size="2" color="#000080">This function opens a
connection with an application listening on the port specified by the parameter <i>port</i>.
Protocol specifies the&nbsp;<br></font></p>
...
<table border="0" width="100%" bordercolor="#000000" bordercolordark="#000080" bordercolorlight="#000080">
  <tr>
    <td valign="top"><font color="#000080" size="2" face="Verdana"><b>See Also
      : </b><a href="MXOpenFile.html">MXOpenFile</a>, <a href="MXOpenBase.html">MXOpenBase</a><b><br>
