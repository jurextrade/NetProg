...
SCPROCRESULT SCMXAddPort (SC* psc,  SCAction* thisaction)
{
    ...
    Error = MXAddPort (psc->MX, (WORD)Val1->Val, MXGetProtocolFromName (SProtocol));
...
SCPROCRESULT SCMXOpenCom (SC* psc,  SCAction* thisaction)
{
    ...
    else
    {
        if ((Val2->Type == SCSTRING) ||
            ...
            pcom = MXOpenTCP (pcv, (char*)Val1->Val, (WORD)Val2->Val, MXGetProtocolFromName (SProtocol), NULL, NULL, 1);
    }
...
SCPROCRESULT  SCMXGetRangeValue (SC* psc, SCAction* thisaction)
{
    ...
    if (pobject)
    {
        ...
        case  MXBUFFER :
            SCSETRETURNVALUETYPE(thisaction->Value, SCPOINTER);
            SCAffectValue (thisaction->Value, (void*)MXGetRangeValue ((MXMessage*)Val1->Val, (int)Val2->Val, (int)Val3->Val), SCLONG);
            break;
        case  MXWORD  :
            SCSETRETURNVALUETYPE(thisaction->Value, SCINTEGER);
            SCAffectValue (thisaction->Value, (void*)((WORD)MXGetRangeValue ((MXMessage*)Val1->Val, (int)Val2->Val, (int)Val3->Val)), SCLONG);
            break;
        case  MXSHORT :
            SCSETRETURNVALUETYPE(thisaction->Value, SCINTEGER);
            SCAffectValue (thisaction->Value, (void*)((SHORT)MXGetRangeValue ((MXMessage*)Val1->Val, (int)Val2->Val, (int)Val3->Val)), SCLONG);
            break;
        case  MXDWORD :
            SCSETRETURNVALUETYPE(thisaction->Value, SCLONG);
            SCAffectValue (thisaction->Value, (void*)((DWORD)MXGetRangeValue ((MXMessage*)Val1->Val, (int)Val2->Val, (int)Val3->Val)), SCLONG);
            break;
        case  MXLONG  :
            SCSETRETURNVALUETYPE(thisaction->Value, SCLONG);
            SCAffectValue (thisaction->Value, (void*)((LONG)MXGetRangeValue ((MXMessage*)Val1->Val, (int)Val2->Val, (int)Val3->Val)), SCLONG);
            break;
        case  MXDOUBLE:
            SCSETRETURNVALUETYPE(thisaction->Value, SCLONG);
            SCAffectValue (thisaction->Value, (void*)((LONG)MXGetRangeValue ((MXMessage*)Val1->Val, (int)Val2->Val, (int)Val3->Val)), SCLONG);
...
SCPROCRESULT  SCMXGetValue (SC* psc, SCAction* thisaction)
{
    ...
    if (pobject)
    {
        ...
        case  MXBUFFER :
            SCSETRETURNVALUETYPE(thisaction->Value, SCPOINTER);
            SCAffectValue (thisaction->Value, (void*)MXGetValue ((MXMessage*)Val1->Val, (char*)Val2->Val, (int)Val3->Val), SCLONG);
            break;
        case  MXWORD  :
            SCSETRETURNVALUETYPE(thisaction->Value, SCINTEGER);
            SCAffectValue (thisaction->Value, (void*)((WORD)MXGetValue ((MXMessage*)Val1->Val, (char*)Val2->Val, (int)Val3->Val)), SCLONG);
            break;
        case  MXSHORT :
            SCSETRETURNVALUETYPE(thisaction->Value, SCINTEGER);
            SCAffectValue (thisaction->Value, (void*)((SHORT)MXGetValue ((MXMessage*)Val1->Val, (char*)Val2->Val, (int)Val3->Val)), SCLONG);
            break;
        case  MXDWORD :
            SCSETRETURNVALUETYPE(thisaction->Value, SCLONG);
            SCAffectValue (thisaction->Value, (void*)((DWORD)MXGetValue ((MXMessage*)Val1->Val, (char*)Val2->Val, (int)Val3->Val)), SCLONG);
            break;
        case  MXLONG  :
            SCSETRETURNVALUETYPE(thisaction->Value, SCLONG);
            SCAffectValue (thisaction->Value, (void*)((LONG)MXGetValue ((MXMessage*)Val1->Val, (char*)Val2->Val, (int)Val3->Val)), SCLONG);
            break;
        case  MXDOUBLE:
            SCSETRETURNVALUETYPE(thisaction->Value, SCLONG);
            SCAffectValue (thisaction->Value, (void*)((LONG)MXGetValue ((MXMessage*)Val1->Val, (char*)Val2->Val, (int)Val3->Val)), SCLONG);
