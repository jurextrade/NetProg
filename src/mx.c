...
int MXAddDGCommands (MX* pmx)
{
    ...
    MXCreateMessageClass(pmx, pclass, "GetFile",             3, 7, "STRING", 1, "Command",
                         "LONG",   1, "Identity",
                         "STRING", 1, "FileName",
                         "STRING", 1, "DestName",
                         "CHAR",   1, "FileType",
    ...
    MXCreateMessageClass(pmx, pclass, "RemoveFiles",         4, 4, "STRING", 1, "Command",
                         "LONG",   1, "Identity",
                         "STRING", 1, "FileNames",
                         "CHAR",   1, "FileLoc");


    MXCreateMessageClass(pmx, pclass, "RenameFile",           5, 5,"STRING", 1, "Command",
                         "LONG",   1, "Identity",
                         "STRING", 1, "OldName",
                         "STRING", 1, "NewName",
                         "CHAR",   1, "FileLoc");

    MXCreateMessageClass(pmx, pclass, "FileReply",            6, 6,"STRING", 1, "Command",
                         "LONG",   1, "Identity",
                         "STRING", 1, "FileName",
                         "SHORT",  1, "NbFiles",
                         "SHORT",  1, "NbFile",
    ...
    MXCreateMessageClass(pmx, pclass, "ChangeDir",            7, 4, "STRING", 1, "Command",
                         "LONG",   1, "Identity",
                         "STRING", 1, "NewDir",
                         "CHAR",   1, "FileLoc");

    MXCreateMessageClass(pmx, pclass, "MakeDir",              8, 4, "STRING", 1, "Command",
                         "LONG",   1, "Identity",
                         "STRING", 1, "Dir",
                         "CHAR",   1, "FileLoc");

    MXCreateMessageClass(pmx, pclass, "RemoveDir",            9, 4, "STRING", 1, "Command",
                         "LONG",   1, "Identity",
                         "STRING", 1, "Dir",
                         "CHAR",   1, "FileLoc");

    MXCreateMessageClass(pmx, pclass, "GetDir",              10, 3, "STRING", 1, "Command",
                         "LONG",   1, "Identity",
                         "CHAR",   1, "FileLoc");

    MXCreateMessageClass(pmx, pclass, "DirReply",            11, 4, "STRING", 1, "Command",
                         "LONG",   1, "Identity",
                         "STRING", 1, "Dir",
                         "LONG",   1, "Error");

    MXCreateMessageClass(pmx, pclass, "PutError",            12, 4, "STRING", 1, "Param",
                         "LONG",   1, "Identity",
                         "SHORT",  1, "Stop",
                         "LONG",   1, "Error");

    MXCreateMessageClass(pmx, pclass, "AckMessage",          13, 4, "LONG",   1, "Identity",
                         "DWORD",  1, "Date",
                         "DWORD",  1, "Hour",
                         "LONG",   1, "Error");

    MXCreateMessageClass(pmx, pclass, "SendClassConnection", 14, 5, "STRING",   1, "Name",
                         "WORD",     1, "Port",
                         "WORD",     1, "Code",
                         "STRING",   1, "TableName",
                         "BYTE",    1, "FromTo");

    MXCreateMessageClass(pmx, pclass, "ReplyClassConnection",15, 2, "STRING",   1, "Name",
                         "LONG",     1, "Error");


    MXCreateMessageClass(pmx, pclass, "List",                16, 4, "STRING", 1, "Command",
                         "LONG",   1, "Identity",
                         "STRING", 1, "Name",
                         "CHAR",   1, "FileLoc");

    MXCreateMessageClass(pmx, pclass, "ListReply",           17, 9, "STRING", 1, "Command",
                         "LONG",   1, "Identity",
                         "STRING", 1, "Name",
                         "STRING", 1, "Access",
                         "STRING", 1, "Date",
    ...
    MXCreateMessageClass(pmx, pclass, "Dir",                 18, 4, "STRING", 1, "Command",
                         "LONG",   1, "Identity",
                         "STRING", 1, "Name",
                         "CHAR",   1, "FileLoc");

    MXCreateMessageClass(pmx, pclass, "GDirReply",           19, 3, "STRING", 1, "Command",
                         "LONG",   1, "Identity",
                         "BUFFER", 1, "Buffer");
...
int MXAddHTTPCommands (MX* pmx)
{
    ...
    pmessageClass =
        MXCreateMessageClass(pmx, pclass, "Request",              1, 29,"STRING",   1,     "Request-Line",
    ...
    MXCreateMessageClass(pmx, pclass, "Response",              2, 31,"STRING",   1,     "Status-Line",
                         "STRING",   1,     "Cache-Control",
                         "STRING",   1,     "Connection",
                         "STRING",   1,     "Date",
                         "STRING",   1,     "Pragma",
...
int MXLoadResourceFile (MX *pmx, char *Filename)
{
    ...
    while(AllXlatStruct)
    {
        Xlat = (XlatStruct *)AllXlatStruct->car;
        XFLoadSystemTable((XFTable *)Xlat);
