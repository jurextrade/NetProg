...
/*-----------------------------------------------------------------------------*/
/* OSFreeShow : fonction de libération d'une structure OSShow                  */
/*-----------------------------------------------------------------------------*/
...
/*-----------------------------------------------------------------------------*/
/* OSAddNewContextToShow : fonction permettant de réallouer un nouveau         */
...
/*-----------------------------------------------------------------------------*/
/* OSFreeSqlda : fonction de libération d'une structure OSSqlda                */
/*-----------------------------------------------------------------------------*/
...
/*-----------------------------------------------------------------------------*/
/* OSAddNewContextToSqlda : fonction permettant de réallouer un nouveau        */
...
/*-----------------------------------------------------------------------------*/
/* OSDisconnect : fonction de déconnection avec commit ou rollback             */
/*-----------------------------------------------------------------------------*/
...
#ifdef SQLDS
    if (protocol == DBPROTO_SQLDS)
        return sqlds_connect (DataBaseName, UserName, PassWord, AckProcedure, AckProcedurePar);
#endif
#ifdef ODBC
    if (protocol == DBPROTO_ODBC)
...
/*-----------------------------------------------------------------------------*/
/* OSExecute : fonction appelée suite à un DBExecute pour exécuter une         */
/*             requête de type UPDATE ou INSERT.                               */
/*-----------------------------------------------------------------------------*/
...
/*-----------------------------------------------------------------------------*/
/* OSProcess : fonction appelée suite à un DBProcess pour exécuter une         */
...
/*-----------------------------------------------------------------------------*/
/* OSRecupShow :fonction appelée suite à un DBShow pour exécuter une           */
/*             requête de type SHOW .                                          */
/*-----------------------------------------------------------------------------*/
...
/*-----------------------------------------------------------------------------*/
/* OSDefaultAckProc :      fonction affectée par défault à                     */
/*                         pack->AckProcedure pour traiter le code retour      */
/*                         d'une requête SQL.                                  */
/*                         Cette fonction affiche à l'écran le code retour     */
/*                         (sqlcode).                                          */
/*-----------------------------------------------------------------------------*/
...
/*-----------------------------------------------------------------------------*/
/* OSDefaultContentsShowProc :  fonction affectée par défault à                */
/*                              pshow->ContentsProcedure pour traiter les      */
/*                              valeurs de retour d'une requête de type        */
/*                              SHOW.                                          */
/*                              Cette fonction effectue l'affichage à          */
/*                              l'écran des données.                           */
/*-----------------------------------------------------------------------------*/
...
/*-----------------------------------------------------------------------------*/
/* OSDefaultHeaderSqldaProc : fonction affectée par défault à                  */
/*                            psqlda->HeaderProcedure pour traiter le          */
/*                            Header d'une requête de type SELECT.             */
/*                            Cette fonction effectue l'affichage à l'écran    */
/*                            du Header.                                       */
/*-----------------------------------------------------------------------------*/
...
/*-----------------------------------------------------------------------------*/
/* OSDefaultContentsSqldaProc : fonction affectée par défault à                */
